...
class WhitelistCheck {
    ...
    private static final String STICKER_APP_AUTHORITY = "com.example.stickersapp.stickercontentprovider";
    //
    /*public static final boolean DEBUG = Boolean.parseBoolean("true");
    public static final String APPLICATION_ID = "com.example.stickersapp";
    public static final String BUILD_TYPE = "debug";
    public static final String FLAVOR = "";
    public static final int VERSION_CODE = 13;
    public static final String VERSION_NAME = "3.1-FINAL";
