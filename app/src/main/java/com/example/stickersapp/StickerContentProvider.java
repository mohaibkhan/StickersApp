...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final Uri AUTHORITY_URI = new Uri.Builder().scheme(ContentResolver.SCHEME_CONTENT).authority("com.example.stickersapp.stickercontentprovider").appendPath(StickerContentProvider.METADATA).build();
    ...
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.example.stickersapp.stickercontentprovider";
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + "com.example.stickersapp.stickercontentprovider" + "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + "com.example.stickersapp.stickercontentprovider" + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + "com.example.stickersapp.stickercontentprovider" + "." + STICKERS;
