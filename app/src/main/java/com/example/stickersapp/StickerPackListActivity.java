...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    TextView tv_title_appbar_layout;
    ...
    private void setIds() {
        tv_title_appbar_layout = findViewById(R.id.tv_title_appbar_layout);
    }

    private void setDataField() {
        tv_title_appbar_layout.setText(getResources().getString(R.string.app_name));
    }
