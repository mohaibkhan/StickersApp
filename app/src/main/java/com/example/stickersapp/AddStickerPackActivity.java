...
import com.facebook.webpsupport.BuildConfig;
...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    private Intent createIntentToAddStickerPack(String identifier, String stickerPackName) {
        ...
        intent.putExtra(StickerPackDetailsActivity.EXTRA_STICKER_PACK_AUTHORITY, "com.example.stickersapp.stickercontentprovider");
